...
const extractAuditData = (
  ...
  const resourceId =
    pathSegments[3] || extractResourceIdFromResponse(responseData);
  ...
  return {
    ...
    resourceId,
    oldValues:
      method === "PUT" || method === "PATCH" ? req.body.oldValues : undefined,
    newValues:
...
const extractResourceIdFromResponse = (
  responseData: any,
): string | undefined => {
