            ...
            {[
              {
                number: "01",
                title: "Fan tanlang",
                description: "Kerakli fan yoki tilni ro'yxatdan tanlang. 100+ fanlar mavjud.",
                visual: "🎯",
                color: "bg-blue-500",
                bgColor: "bg-blue-50",
              ...
              },
              {
                ...
                description: "Reyting, tajriba va narxlarga qarab o'zingizga mos ustozni tanlang.",
                visual: "👨‍🏫",
              ...
              },
              {
                ...
                description: "Qulay vaqtni belgilang va darsni bron qiling. Moslashuvchan jadval.",
                visual: "📅",
                color: "bg-purple-500",
              ...
              },
              {
                ...
                description: "Platforma orqali video chat orqali darsga qo'shiling. Interaktiv o'qish.",
                visual: "💻",
                color: "bg-orange-500",
              ...
              },
              {
                ...
                description: "Muntazam darslar bilan bilimlaringizni rivojlantiring va maqsadlaringizga erishing.",
                visual: "🚀",
                color: "bg-pink-500",
                bgColor: "bg-pink-50",
              ...
              <div key={index} className={`relative group ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''} flex flex-col lg:flex-row items-center gap-12 lg:gap-20`}>
                {/* Visual Side */}
                <div className="flex-1 lg:max-w-xl">
                  <div className={`relative ${step.bgColor} rounded-3xl p-12 lg:p-16 transition-all duration-500 group-hover:scale-105`}>
                ...
                <div className="flex-1 lg:max-w-xl text-center lg:text-left">
                  <div className={`inline-flex items-center justify-center w-20 h-20 ${step.color} text-white rounded-2xl text-2xl font-bold mb-6 shadow-lg`}>
                    {step.number}
                  </div>
