...
const paymentProviders = [
  {
    ...
    name: "Click",
    logo: "💳",
    description: "Kartalar va mobil to'lov",
  },
  {
    id: "payme",
    name: "Payme",
...
const Booking: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log("Analytics: booking_view", {
  ...
  const handleBookingConfirm = async () => {
    ...
    console.log("Analytics: booking_confirm_attempt", {
      tutorId: slotData.tutorId,
    });
  ...
  const handlePaymentProceed = async () => {
    ...
    try {
      ...
      const redirectUrl =
        mockPaymentUrls[
          bookingState.selectedProvider as keyof typeof mockPaymentUrls
        ];

      // Show success message instead of redirecting (for demo)
      toast.success(
        `To'lov sahifasiga yo'naltirilmoqda: ${bookingState.selectedProvider.toUpperCase()}`,
      );
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm">
                      {slotData.tutorRating.toFixed(1)}
                    </span>
                  </div>
                </div>
              </div>
